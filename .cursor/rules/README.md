...
| `06-rule-drift-guard.mdc` | Auto-Attached | `.cursor/rules/**`、`.cursor/skills/**` |
| `07-xijia-skill-naming.mdc` | Auto-Attached | `.cursor/skills/**`、`.cursor/commands/**` |
...
`afterFileEdit` → `python .cursor/hooks/drift_guard_scan.py`  
