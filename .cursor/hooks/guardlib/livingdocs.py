...
BACKTICK_DOC_RE = re.compile(r"`((?:docs/|AGENTS\.md|README\.md|\.cursor/)[^`]+)`")
...
def collect_links_from_text(text: str, source_rel: str) -> list[str]:
    ...
    if source_rel == "docs/llms.txt":
        for line in text.splitlines():
            ...
            if candidate.startswith(("docs/", "AGENTS.md", "README.md", ".cursor/")):
...
def resolve_doc_link(link: str, source_rel: str) -> Path | None:
    ...
    if part.startswith(("docs/", ".cursor/")) or part in ("AGENTS.md", "README.md"):
