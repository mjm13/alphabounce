...
- ``rule:``  on-demand rules (``alwaysApply: false``) under ``.cursor/rules/``
- ``skill:`` model-invoked skills under ``.cursor/skills/`` and ``.agents/skills/``
...
``observability/`` and user-level ``~/.cursor/skills-cursor/`` fall outside every
