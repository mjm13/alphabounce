...
| 无原型缺布局预览 | xijia-prd-to-requirement | Step 4a / `.cursor/templates/requirements/gate1-plan-template.md` |
| 模板双源 | 任意 | 禁止在 `docs/requirements/` 维护 `*-template.md`；SSOT 见 `.cursor/templates/requirements/` |
