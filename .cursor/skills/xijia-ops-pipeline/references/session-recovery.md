...
2. `python .cursor/hooks/pipeline_guard.py --audit`（仅用户说「展开诊断」时）
3. 文件证据优先于摘要 Stage
4. verify 三件套无记录 = 未完成
...
```powershell
python .cursor/hooks/pipeline_guard.py --gate3-trigger-report --req docs/requirements/inbox/<file>.md
python .cursor/hooks/pipeline_guard.py --check-gate3-preflight --req docs/requirements/inbox/<file>.md
