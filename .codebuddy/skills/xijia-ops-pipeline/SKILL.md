...
1. 硬门禁见 `.codebuddy/rules/00-workflow.mdc`（Gate-0/1/2/3、Approval Gates）
...
| Gate-0 程序细节 | [`.codebuddy/templates/requirements/gate0-intake.md`](../templates/requirements/gate0-intake.md) |
