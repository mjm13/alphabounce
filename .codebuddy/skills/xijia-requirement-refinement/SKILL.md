...
| Gate-0 程序字段 | [`.codebuddy/templates/requirements/gate0-intake.md`](../../templates/requirements/gate0-intake.md) |
| Gate-1 布局预览片段（供 prd/A.0.5 引用；**本技能不写**） | [`.codebuddy/templates/requirements/section-fragments.md`](../../templates/requirements/section-fragments.md) § Gate-1 / 页面布局预览 |
