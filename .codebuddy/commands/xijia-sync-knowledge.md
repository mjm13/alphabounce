...
3. **First command:** `python .codebuddy/hooks/pipeline_guard.py --gate3-trigger-report --req <inbox-path>`
...
7. Run `python .codebuddy/hooks/pipeline_guard.py --check-closeout --req <shipped-requirement-path>`.
