...
## 实现方案
- 复用映射 / 代码落点：`.codebuddy/templates/requirements/requirements-template.md`
- 切片拆解：
  1. [AC-1] 重排模板
- 回归验证点：`python -m pytest .codebuddy/hooks/tests -q`
...
class RequirementTemplateStructureTests(unittest.TestCase):
    TEMPLATE_PATHS = (
        ...
        ".codebuddy/templates/requirements/technical-requirement-template.md",
        ".codebuddy/templates/requirements/defect-template.md",
        ".codebuddy/skills/xijia-project-init/templates/docs/requirements/inbox-seed/backend-bootstrap.md.tmpl",
        ".codebuddy/skills/xijia-project-init/templates/docs/requirements/inbox-seed/frontend-bootstrap.md.tmpl",
        ".codebuddy/skills/xijia-project-init/templates/docs/requirements/inbox-seed/runtime-baseline.md.tmpl",
    )

    GATE_TEMPLATE_PATHS = (
        ".codebuddy/templates/requirements/gate0-intake.md",
        ".codebuddy/templates/requirements/gate1-plan-template.md",
        ".codebuddy/templates/requirements/gate1-by-tier.md",
        ".codebuddy/templates/requirements/section-fragments.md",
    )
    ...
    def test_general_requirement_template_contains_ambiguity_and_evidence_gates(self) -> None:
        rel = ".codebuddy/templates/requirements/requirements-template.md"
        text = (paths.ROOT / rel).read_text(encoding="utf-8")
