...
CHECKS: list[tuple[str, str, list[str]]] = [
    ...
    (
        ...
        ".codebuddy/skills/xijia-ops-pipeline/references/closeout-steps.md",
        ["check-closeout", "check-release", "check-gate3-preflight", "gate3-trigger-report", "archive-requirement"],
    ),
    (
        "release rule",
        ".codebuddy/rules/47-release-lifecycle.mdc",
        ["Release Gate", "check-release-readiness"],
    ),
    (
        "release command",
        ".codebuddy/commands/xijia-release.md",
        ["check-release-readiness"],
    ),
    (
        "release skill",
        ".codebuddy/skills/xijia-release/SKILL.md",
    ...
    (
        ...
        ".codebuddy/skills/xijia-ops-pipeline/references/session-recovery.md",
    ...
    (
        "defect command",
        ".codebuddy/commands/xijia-defect.md",
        ["xijia-defect-to-requirement"],
    ),
    (
        "prd prototype early-diff",
        ".codebuddy/skills/xijia-prd-to-requirement/references/gate0-checklist.md",
        ["原型现状（相对 PRD）", "Step 1.2", "以PRD为准"],
    ),
    (
        "init docs-render",
        ".codebuddy/skills/xijia-project-init/SKILL.md",
        ["docs-render", "code-shell", "seed-bootstrap-reqs"],
    ),
    (
        "sync-knowledge capability",
        ".codebuddy/skills/xijia-sync-knowledge/references/gate3-archive.md",
    ...
    (
        ...
        ".codebuddy/skills/xijia-sync-knowledge/SKILL.md",
        ["gate3-archive.md", "Capability Index", "domain-merge.md"],
    ),
    (
        "prd step 1.7",
        ".codebuddy/skills/xijia-prd-to-requirement/SKILL.md",
    ...
    (
        ...
        ".codebuddy/skills/xijia-ops-pipeline/references/verify-closeout.md",
        ["xijia-frontend-test", "lint/build", "运行时证据"],
    ),
    (
        "visible state machine tiering",
        ".codebuddy/skills/xijia-ops-pipeline/references/tier-routing.md",
        ["用户可见状态机", "最低为 **yellow**", "brainstorming"],
    ),
    (
        "init rule D+",
        ".codebuddy/rules/05-project-init.mdc",
    ...
    (
        ...
        [
            ...
            "H2 必须位于对应 Gate 父层",
            ".codebuddy/templates/requirements/requirements-template.md",
        ],
    ),
    (
        "public templates SSOT",
        ".codebuddy/templates/README.md",
        [
    ...
    (
        "prd command",
        ".codebuddy/commands/xijia-prd.md",
        ["xijia-prd-to-requirement"],
    ),
    (
        "sync-knowledge all tiers",
        ".codebuddy/commands/xijia-sync-knowledge.md",
        ["All tiers", "xijia-sync-knowledge"],
    ),
    (
        "git branching",
        ".codebuddy/rules/46-git-branching.mdc",
    ...
    (
        "opsx archive thin",
        ".codebuddy/commands/opsx-archive.md",
...
_LEGACY_SCAN_EXCLUDE = frozenset(
    {
        ".codebuddy/skills/xijia-project-init/scripts/render_init_templates.py",
        ".codebuddy/hooks/policy_flow_drift_check.py",
        ".codebuddy/hooks/tests/test_pipeline_guard_checks.py",
    }
)
...
ENTRYPOINTS = [
    ...
    ".codebuddy/commands/xijia-adopt.md",
    ".codebuddy/commands/xijia-start.md",
    ".codebuddy/commands/xijia-status.md",
    ".codebuddy/commands/xijia-stop.md",
    ".codebuddy/commands/xijia-sync-knowledge.md",
    ".codebuddy/commands/xijia-release.md",
    ".codebuddy/commands/xijia-defect.md",
    ".codebuddy/commands/xijia-prd.md",
    ".codebuddy/commands/xijia-overview.md",
    ".codebuddy/commands/xijia-backfill-index.md",
    ".codebuddy/commands/xijia-finish-branch.md",
    ".codebuddy/commands/opsx-explore.md",
    ".codebuddy/commands/opsx-propose.md",
    ".codebuddy/commands/opsx-analyze.md",
    ".codebuddy/commands/opsx-apply.md",
    ".codebuddy/commands/opsx-sync.md",
    ".codebuddy/commands/opsx-archive.md",
]
