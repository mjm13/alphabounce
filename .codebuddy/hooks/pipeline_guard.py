...
7. ``--check-release-readiness``: Release Gate read-only audit before cutting release/<version>.
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Release Gate audit before cutting release/<version> (checklist, AGENTS, CI, inbox warnings)",
    )
    parser.add_argument(
        "--check-req-ids",
        action="store_true",
