...
class Cs { // }
	...
	//
	public inline static var MAX_BALL = 18;
	public inline static var MAX_OPTION = 6;

	public inline static var BALL_STANDARD = 0;
	public inline static var BALL_FIRE = 1;
	public inline static var BALL_ICE = 2;
	public inline static var BALL_DRUNK = 3;
	public inline static var BALL_KAMIKAZE = 4;
	public inline static var BALL_YOYO = 5;
	public inline static var BALL_HALO = 6;
	public inline static var BALL_SHADE = 7;
	public inline static var BALL_VOLT = 8;

	public inline static var PAD_STANDARD = 0;
	public inline static var PAD_GLUE = 1;
	public inline static var PAD_TIME = 2;
	public inline static var PAD_LASER = 3;
	public inline static var PAD_GENERATOR = 4;
	public inline static var PAD_AIMANT = 5;

	public inline static var PAD_SHAKE = 6;

	// GAMEPLAY
	public inline static var TEMPO = 120;
	public inline static var DOOR_COEF = 0.25;

	public inline static var OPTION_COEF = 0.1;
	...
	//
	public static function log(str, ?pos:PosInfos) {
		Manager.log(str, pos);
	}
