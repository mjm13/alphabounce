class TextFr { // }
	...
	public static var PAUSE_TEXT = [
		"SELECTIONNER UNE CAPSULE OU APPUYER SUR \"P\" POUR QUITTER LA PAUSE",
		"APPUYER SUR \"P\" POUR QUITTER LA PAUSE"
	];
	...
	public static var PREF_FLAGS = [
		"CONTROLE CLAVIER",
		"MOUVEMENTS VISIBLE",
		"ZONE AVERTISSEMENT",
		"BALLE SUPER CONTRASTE "
	];
	...
	public static var OPTION_NAMES = [
		"AIMANT", "BLINDAGE", "COLLE", "DIMINUTION", "EXTENSION", "FLAMME", "GLACE", "HALO", "INDIGESTION", "JAVELOT", "KAMIKAZE", "LASER", "MULTI-BALL",
		"NOUVELLE BALLE", "OUVERTURE", "PROVISION", "QUASAR", "REGENERATION", "SAUVETAGE", "TRANSFORMATION", "ULTRAVIOLET", "VOLT", "WHISKY", "XANAX", "YOYO",
		"ZELE", "MISSILE",
	];
	...
	/// TRAVELER ///
	////////////////
	public static var TRAVELER_NAMES = [
		"Walter", "Ben", "Jokarix", "Goshmael", "Mirmonide", "Korkan", "Gifu", "Birman", "Falgus", "Moktin", "Bifouak", "Lacune", "Gibarde", "Blafaro",
		"Kimper", "Sochmo", "Nicolu", "Mangerin", "Difidus", "Stridan", "Glochar", "Mikou", "Kilian", "Daston", "Possei", "Spido", "Corneli", "Brifuk",
		"Colcanis", "Frederak", "Coustini", "Darnold", "Fruncky", "Jimic", "Sachude", "Bramhan", "Nucrcela", "Baguera", "Ismael", "Gorgonzi", "Bashkod",
		"Dangoren", "Astefik", "Mouroud", "Babacar", "Disnouie", "Kisby", "Bastiar", "Amilou", "Fromest", "Ambrun", "Caushmil", "Poubreso", "Flaurest",
		"Moliur", "Nasting", "Boumbo", "Kig", "Sproutch", "Zoobik", "Morvoyeu", "Shandwiz", "Guilbard", "Mocheron", "Lakune", "Stokoln", "Tartantua",
		"Saphyr", "Gouperin", "Chogrom", "Kaskubi", "Panzeman", "Yuyu", "Pirlui", "Saxtan", "Coulepron", "Barzan", "Jean-Cloud", "Chourizou", "Stupood",
		"Drasteam", "Weathy"
	];
	...
	public static var TRAVELER_USER = ["vendeur", "avaleur", "testeur", "lanceur", "gouteur", "chasseur",];

	public static var TRAVELER_STUFF_0 = [
		"chantilly", "sentiments", "petit-suisses", "sangliox", "capsule d'hydrogène", "conglomérats", "pierres préciseuses", "plasma energetique",
		"cable electriques", "chaussures liquides", "crème de viande", "carcasses d'enveloppes", "kebab", "lampe torche", "cartouche SNES", "sushi",
		"croissants",
	];
	...
	public static var TRAVELER_LEAVE_PLANET = [
		...
		[
			...
			"La nuit dernière la temperature est tombé a -50Â°, j'ai perdu un orteil...",
	...
	public static var BUTTON_PEOPLE = ["ACCEPTER", "REFUSER", "PARTIR", "DENONCER",];
