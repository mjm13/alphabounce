...
class Menu { // }
	...
	var sens:Int;
	var coef:Float;
	var fieldLog:pixi.core.text.Text;
	var fieldLog2:pixi.core.text.Text;
	var root:display.ASprite;
	var map:navi.Map;
	// var mcIcon:display.ASprite;
	var mcDraw:display.ASprite;
	...
	// HINTS
	function setHint(mc:display.ASprite, str) {
		mc.onRollOver = displayHint.bind(str);
