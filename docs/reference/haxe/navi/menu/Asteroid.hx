...
class Asteroid extends navi.Menu { // }
	...
	override function init() {
		...
		/*for (x in 0...xmax)
				bmpBg.fillRect(new flash.geom.Rectangle(x * sq, 0, 1, Cs.mch), col);
			for (y in 0...ymax)
				bmpBg.fillRect(new flash.geom.Rectangle(0, y * sq, Cs.mcw, 1), col); */
		trace("FIXME");
		...
		game.blendMode = pixi.core.Pixi.BlendModes.ADD;
