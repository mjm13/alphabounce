...
> 字段骨架见 [`.cursor/templates/requirements/gate1-plan-template.md`](gate1-plan-template.md)。  
...
python .cursor/hooks/pipeline_guard.py --check-plan --req <file>   # 绿/黄/无包红：期望 exit=0
```
